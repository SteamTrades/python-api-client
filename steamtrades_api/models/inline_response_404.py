...
class InlineResponse404(object):
    ...
    def missing_items(self):
        """
        Gets the missing_items of this InlineResponse404.
        List of asset IDs of missing items, causing this error

        :return: The missing_items of this InlineResponse404.
        :rtype: list[str]
        """
    ...
    def missing_items(self, missing_items):
        """
        Sets the missing_items of this InlineResponse404.
        List of asset IDs of missing items, causing this error

        :param missing_items: The missing_items of this InlineResponse404.
        :type: list[str]
        """
